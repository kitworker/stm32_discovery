...
C_SRCS += \
../LCD/stm32_ld_vl/LCD/delay/delay.c 

OBJS += \
./LCD/stm32_ld_vl/LCD/delay/delay.o 

C_DEPS += \
./LCD/stm32_ld_vl/LCD/delay/delay.d 


# Each subdirectory must supply rules for building sources it contributes
LCD/stm32_ld_vl/LCD/delay/%.o: ../LCD/stm32_ld_vl/LCD/delay/%.c
	@echo 'Building file: $<'
